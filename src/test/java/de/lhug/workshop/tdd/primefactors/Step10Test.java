...
public class Step10Test {

    private Step10 sut = new Step10();
    ...
    @Test
    public void shouldReturnTwoThreesWhenNumberIsNine() throws Exception {
        List<Integer> result = sut.primeFactors(9);

        assertThat(result, contains(3, 3));
    }

    @Test
    public void shouldReturnFactorsForLargeNumber() throws Exception {
        List<Integer> result = sut.primeFactors(2 * 2 * 2 * 2 * 3 * 5 * 7 * 11 * 13);

        assertThat(result, contains(2, 2, 2, 2, 3, 5, 7, 11, 13));
    }
}
